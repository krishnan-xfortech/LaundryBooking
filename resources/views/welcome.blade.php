...
@section('content')
    <div class="flex flex-col w-full h-[100vh] items-center">
        <div class="flex w-full h-10 justify-between items-center bg-slate-100">
        ...
        <div class="flex w-full h-[40%] bg-slate-200">
        ...
        <div class="flex flex-col w-full h-60 justify-center items-center px-10">
            <div class="flex w-full h-20 justify-center items-center">
                <span class="text-xl font-semibold">Our Services</span>
            </div>
            <div class="flex w-full h-40 justify-center items-center gap-20">
                <div
        ...
        <div class="flex w-full h-40 mt-10 pt-10 justify-center items-center bg-gradient-to-r from-rose-100 to-teal-100">
            <figure class="w-full mx-auto text-center bg-gradient-to-r from-rose-100 to-teal-100">
                ...
                <blockquote>
                    <p class="text-2xl italic font-medium">"Lorem ipsum, dolor sit amet consectetur
        ...
        <footer class="rounded-lg shadow mt-5  w-full h-40">
